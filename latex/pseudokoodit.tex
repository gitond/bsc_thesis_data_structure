...
%		\If{$kasiteltava = maalisolmu$}
%			\While{$vanhemmat[kasiteltava] \not= -1$}
...
%\algstore{bfsbreak}
%\end{algorithmic}
%\end{algorithm}				%%%	Something here breaks
%\begin{algorithm}				%%%
%\caption{Esimerkki BFS-algoritmista (osa 2)}
%\begin{algorithmic}
%\algrestore{bfsbreak}
%
...
%		\Else
%			\ForAll{$n \in graafidata.naapurit(kasiteltava)$}
%				\If{$(n \not\in vieraillut) \land (n \not\in kasiteltavat)$}
